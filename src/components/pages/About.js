...
export default function About() {
  ...
  return (
    <div>
      <div className="jumbotron text-center" style={styles.heroBox}>
        <div style={{ margin: "auto 0" }}>
          <h1>Pupster</h1>
          <h2>They're the Good Boys and Girls</h2>
        </div>
      </div>
      <div className="container" style={styles.aboutCont}>
        <div className="row">
